...
\`PromptDex\` does not directly use cookies. However, some third-party services we utilize, such as PostHog and Sentry, may use cookies to monitor interactions with our Service. Additionally, cookies are used for authentication purposes. You have the option to either accept or decline these cookies and should refer to your browser settings for managing your preferences.
...
If you have any questions or concerns about this Privacy Policy, please feel free to contact us at [support@promptdex.co](mailto:support@promptdex.co). We will do our best to respond to your inquiries promptly.
`;
