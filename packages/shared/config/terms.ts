...
Welcome to PromptDex! These Terms and Conditions ("Terms") govern your use of the PromptDex website and services (the "Service"). By accessing or using our Service, you agree to be bound by these Terms. If you do not agree with any part of these Terms, you must not use the Service.
...
- "Service" refers to the PromptDex platform, including all related software, applications, and services provided by PromptDex.
...
At PromptDex, we prioritize your privacy. We do not store your chat history on our servers. All chat history is stored locally on your device, and we do not have access to your personal conversations. By using the Service, you agree to this local storage and understand that you are responsible for securing your own data.
...
The outputs from PromptDex are generated using large language models. These outputs might not always be accurate, complete, or up-to-date. You acknowledge that all outputs and responses are provided on an "as is" basis. The Service is not a substitute for professional advice (legal, medical, financial, or otherwise). Always seek the guidance of qualified professionals before making decisions based on the outputs generated by the Service.

### 8. Intellectual Property

- Ownership: PromptDex and its licensors own all rights, title, and interest in and to the Service, including any underlying software, technology, and content (excluding User Content).
- User Content License: By submitting or transmitting any content ("User Content") to the Service, you grant PromptDex a non-exclusive, worldwide, royalty-free license to store, display, process, and use your User Content in connection with providing and improving the Service.
- Trademarks: All trademarks, service marks, logos, and trade names belonging to PromptDex are trademarks of PromptDex.
...
In no event shall PromptDex, its affiliates, or its licensors be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from:

- Your use or inability to use the Service.
- Any unauthorized access to or use of our servers.
- Any bugs, viruses, or other harmful code.

In no event will PromptDex's total liability exceed one hundred US dollars (USD $100).

### 12. Indemnification

You agree to indemnify, defend, and hold harmless PromptDex, its affiliates, and its licensors from and against any and all claims, damages, losses, liabilities, costs, and expenses arising from or related to your use of the Service or any violation of these Terms.
...
- Entire Agreement: These Terms constitute the entire agreement between you and PromptDex regarding your use of the Service.
